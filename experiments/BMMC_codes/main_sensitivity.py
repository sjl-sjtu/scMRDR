...
# adata.write(f"/home/bingxing2/ailab/group/ai4bio/sunjianle/mop/BMMC/sensitivity/feature_aligned_{beta}_{gamma}_{lambda_adv}.h5ad")
...
model.inference(n_samples=1,update=True,returns=False)
adata = model.get_adata()
adata.write(f"/home/bingxing2/ailab/group/ai4bio/sunjianle/mop/BMMC/sensitivity/feature_aligned_{beta}_{gamma}_{lambda_adv}_noadv.h5ad")
