...
# harmony
rna.so <- ReadH5AD("/ailab/user/sunjianle-hdd/integration27/mop/muto/RNA_counts_qc.h5ad")
atac.so <- ReadH5AD("/ailab/user/sunjianle-hdd/integration27/mop/muto/ATAC_counts_qc.h5ad")
...
Embeddings(combined.so_harmony, reduction='harmony') |> as.data.frame() |> write.csv("/ailab/user/sunjianle-hdd/integration27/mop/muto/harmony.csv")
saveRDS(combined.so_harmony,"/ailab/user/sunjianle-hdd/integration27/mop/muto/harmony_obj.rds")