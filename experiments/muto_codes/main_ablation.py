...
adata.write("/ailab/user/sunjianle-hdd/integration27/mop/muto/feature_aligned_noiso.h5ad")
...
model.inference(n_samples=1,update=True,returns=False)
adata = model.get_adata()
adata.write("/ailab/user/sunjianle-hdd/integration27/mop/muto/feature_aligned_noadv.h5ad")
...
model.inference(n_samples=1,update=True,returns=False)
adata = model.get_adata()
adata.write("/ailab/user/sunjianle-hdd/integration27/mop/muto/feature_aligned_nobeta.h5ad")
