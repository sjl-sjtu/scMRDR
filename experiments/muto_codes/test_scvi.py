...
adata = sc.read_h5ad("/ailab/user/sunjianle-hdd/integration27/mop/BMMC/feature_aligned.h5ad")
print(adata)
scvi.model.SCVI.setup_anndata(adata, layer="counts", batch_key="batch")
model = scvi.model.SCVI(adata, n_layers=2, n_latent=30, gene_likelihood="zinb")
model.train()
adata.obsm["X_scVI"] = model.get_latent_representation()
np.save("/ailab/user/sunjianle-hdd/integration27/mop/muto/scvi.npy",adata.obsm["X_scVI"])
...
adata.write("/ailab/user/sunjianle-hdd/integration27/mop/muto/scvi_unpaired_modalmix.h5ad")
