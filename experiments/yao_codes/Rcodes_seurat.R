...
seurat.rna <- ReadH5AD("/home/bingxing2/ailab/group/ai4bio/sunjianle/mop/Yao/RNA_counts_qc.h5ad")
seurat.atac <- ReadH5AD("/home/bingxing2/ailab/group/ai4bio/sunjianle/mop/Yao/ATAC_counts_qc.h5ad")
...
gene.activities <- CreateGeneActivityMatrix(peak.matrix = mt, 
    annotation.file = "/home/bingxing2/ailab/group/ai4bio/sunjianle/mop/gencode.vM10.chr_patch_hapl_scaff.annotation.gtf", 
...
# Embeddings(coembed, reduction = "integrated.cca") |> as.data.frame() |> write.csv("/home/bingxing2/ailab/group/ai4bio/sunjianle/mop/Yao/seurat_pca.csv")


# coembed <- RunUMAP(coembed, dims = 1:30)

saveRDS(coembed,"/home/bingxing2/ailab/group/ai4bio/sunjianle/mop/Yao/seurat_obj.rds")
Embeddings(coembed, reduction = "pca") |> as.data.frame() |> write.csv("/home/bingxing2/ailab/group/ai4bio/sunjianle/mop/Yao/seurat_pca.csv")
