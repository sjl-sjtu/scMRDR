...
np.save("/home/bingxing2/ailab/group/ai4bio/sunjianle/mop/Yao/glue_nb_hvg.npy",combined.obsm["X_glue"])
...
atac.obsm["X_glue"] = glue.encode_data("atac", atac)
combined = ad.concat([rna, atac])
np.save("/home/bingxing2/ailab/group/ai4bio/sunjianle/mop/Yao/glue_nb.npy",combined.obsm["X_glue"])
...
atac.obsm["X_glue"] = glue.encode_data("atac", atac)
combined = ad.concat([rna, atac])
np.save("/home/bingxing2/ailab/group/ai4bio/sunjianle/mop/Yao/glue_norm_hvg.npy",combined.obsm["X_glue"])
...
atac.obsm["X_glue"] = glue.encode_data("atac", atac)
combined = ad.concat([rna, atac])
np.save("/home/bingxing2/ailab/group/ai4bio/sunjianle/mop/Yao/glue_norm.npy",combined.obsm["X_glue"])
